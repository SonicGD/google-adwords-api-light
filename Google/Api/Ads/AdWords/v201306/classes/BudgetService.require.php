<?php
require_once('AssociatedCampaign.php');
...
require_once('AssociatedCampaignBudgetCampaignAssociationStatus.php');
require_once('AssociatedCampaignCampaignStatus.php');
