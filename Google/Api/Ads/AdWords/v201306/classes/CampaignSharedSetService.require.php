<?php
require_once('CampaignSharedSet.php');
...
require_once('CampaignSharedSetStatus.php');
...
require_once('SharedSetType.php');
require_once('SizeLimitErrorReason.php');
require_once('SortOrder.php');
require_once('StringLengthErrorReason.php');
require_once('CampaignSharedSetServiceGet.php');
require_once('CampaignSharedSetServiceGetResponse.php');
require_once('CampaignSharedSetServiceMutate.php');
require_once('CampaignSharedSetServiceMutateResponse.php');
...
require_once('CampaignSharedSetOperation.php');
require_once('CampaignSharedSetReturnValue.php');
...
require_once('CampaignSharedSetPage.php');
