<?php
require_once('EnumValuePair.php');
require_once('ReportDefinitionField.php');
...
require_once('ReportDefinitionReportType.php');
require_once('ReportDefinitionErrorReason.php');
...
require_once('getReportFields.php');
require_once('getReportFieldsResponse.php');
...
require_once('ReportDefinitionError.php');
