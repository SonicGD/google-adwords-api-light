...
require_once('AdGroupFeedStatus.php');
...
require_once('AdGroupFeedServiceGet.php');
require_once('AdGroupFeedServiceGetResponse.php');
require_once('AdGroupFeedServiceMutate.php');
require_once('AdGroupFeedServiceMutateResponse.php');
require_once('AdGroupFeedError.php');
require_once('AdGroupFeedOperation.php');
require_once('AdGroupFeedReturnValue.php');
...
require_once('AdGroupFeedPage.php');
