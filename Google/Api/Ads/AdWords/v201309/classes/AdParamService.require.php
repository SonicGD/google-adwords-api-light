<?php
require_once('AdParam.php');
require_once('AdParamPage.php');
...
require_once('AdParamErrorReason.php');
...
require_once('AdParamServiceGet.php');
require_once('AdParamServiceGetResponse.php');
require_once('AdParamServiceMutate.php');
require_once('AdParamServiceMutateResponse.php');
require_once('AdParamError.php');
require_once('AdParamOperation.php');
...
require_once('AdParamPolicyError.php');
