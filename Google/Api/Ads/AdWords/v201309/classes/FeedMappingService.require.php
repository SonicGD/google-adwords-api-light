<?php
require_once('AttributeFieldMapping.php');
require_once('DateRange.php');
require_once('FeedMapping.php');
...
require_once('FeedMappingStatus.php');
require_once('FeedMappingErrorReason.php');
...
require_once('FeedMappingServiceGet.php');
require_once('FeedMappingServiceGetResponse.php');
require_once('FeedMappingServiceMutate.php');
require_once('FeedMappingServiceMutateResponse.php');
...
require_once('FeedMappingError.php');
require_once('FeedMappingOperation.php');
require_once('FeedMappingReturnValue.php');
...
require_once('FeedMappingPage.php');
