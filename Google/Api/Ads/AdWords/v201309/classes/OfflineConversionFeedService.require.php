<?php
require_once('OfflineConversionFeed.php');
...
require_once('OfflineConversionErrorReason.php');
...
require_once('OfflineConversionFeedServiceMutate.php');
require_once('OfflineConversionFeedServiceMutateResponse.php');
...
require_once('OfflineConversionError.php');
require_once('OfflineConversionFeedOperation.php');
...
require_once('OfflineConversionFeedReturnValue.php');
