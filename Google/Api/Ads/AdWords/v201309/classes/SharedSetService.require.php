...
require_once('SharedSetStatus.php');
require_once('SharedSetErrorReason.php');
...
require_once('SharedSetServiceGet.php');
require_once('SharedSetServiceGetResponse.php');
require_once('SharedSetServiceMutate.php');
require_once('SharedSetServiceMutateResponse.php');
...
require_once('SharedSetError.php');
require_once('SharedSetOperation.php');
require_once('SharedSetReturnValue.php');
...
require_once('SharedSetPage.php');
