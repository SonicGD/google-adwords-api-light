...
require_once 'CustomerFeed.php';
require_once 'CustomerFeedError.php';
...
require_once 'CustomerFeedStatus.php';
require_once 'CustomerFeedErrorReason.php';
...
require_once 'CustomerFeedServiceGet.php';
require_once 'CustomerFeedServiceGetResponse.php';
require_once 'CustomerFeedServiceMutate.php';
require_once 'CustomerFeedServiceMutateResponse.php';
require_once 'Query.php';
require_once 'QueryResponse.php';
require_once 'ApiException.php';
require_once 'ConstantOperand.php';
require_once 'CustomerFeedOperation.php';
require_once 'CustomerFeedReturnValue.php';
require_once 'FeedAttributeOperand.php';
require_once 'FunctionOperand.php';
require_once 'NullStatsPage.php';
require_once 'CustomerFeedPage.php';
