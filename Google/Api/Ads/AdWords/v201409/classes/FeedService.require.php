...
require_once('FeedAttribute.php');
...
require_once('SystemFeedGenerationData.php');
...
require_once('FeedOrigin.php');
require_once('FeedStatus.php');
require_once('FeedAttributeType.php');
...
require_once('FeedServiceGet.php');
require_once('FeedServiceGetResponse.php');
require_once('FeedServiceMutate.php');
require_once('FeedServiceMutateResponse.php');
...
require_once('PlacesLocationFeedData.php');
require_once('DatabaseError.php');
require_once('ApiException.php');
require_once('FeedOperation.php');
require_once('FeedReturnValue.php');
