...
require_once('DraftServiceGet.php');
require_once('DraftServiceGetResponse.php');
require_once('DraftServiceMutate.php');
require_once('DraftServiceMutateResponse.php');
...
require_once('DraftOperation.php');
require_once('DraftReturnValue.php');
